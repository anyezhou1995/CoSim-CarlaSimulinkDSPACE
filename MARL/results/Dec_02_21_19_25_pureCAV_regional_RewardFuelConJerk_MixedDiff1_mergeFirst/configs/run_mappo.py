...
def train(args):
    ...
    output_dir = base_dir + now + '_pureCAV_regional_RewardFuelConJerk_MixedDiff1_mergeFirst'
...
def evaluate(args):
    ...
    rewards, eval_info, steps, avg_speeds = mappo.evaluation(env, video_dir, len(seeds), is_train=False)
