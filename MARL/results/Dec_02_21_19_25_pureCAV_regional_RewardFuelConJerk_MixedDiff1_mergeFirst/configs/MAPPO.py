...
class MAPPO:
    ...
    def __init__(self, env, state_dim, action_dim,
        ...
        assert traffic_density in [1, 2, 3, 4, 5]
    ...
    def interact(self):
        ...
        for i in range(self.roll_out_n_steps):
            ...
            if self.reward_type == "regionalR":
                ...
                '''
                reward_g = [global_reward] * self.n_agents
                reward_r = info["regional_rewards"]
                reward = []
                for g, r in zip(reward_g, reward_r):
                    if g > r:
                        reward.append(g)
                    else:
                        reward.append(r)
    ...
    def evaluation(self, env, output_dir, eval_episodes=1, is_train=True):
        ...
        for i in range(eval_episodes):
            ...
            if is_train:
                if self.traffic_density == 1:
                    ...
                    tempa = env.reset(is_training=False, testing_seeds=seeds[i], num_CAV=i+7)
                    state, action_mask = tempa[0], tempa[1]
            else:
            ...
            vehicle_accel.append(info['vehicle_acceleration'])
        ...
        env.close()
        return rewards, (vehicle_action, vehicle_speed, vehicle_position, vehicle_accel), steps, avg_speeds
